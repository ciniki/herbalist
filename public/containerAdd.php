...
function ciniki_herbalist_containerAdd(&$ciniki) {
    ...
    $rc = ciniki_core_prepareArgs($ciniki, 'no', array(
        ...
        'top_price'=>array('required'=>'no', 'blank'=>'yes', 'default'=>'0', 'name'=>'Top Price'),
        'bottom_quantity'=>array('required'=>'no', 'blank'=>'yes', 'default'=>'0', 'name'=>'Bottom Quantity'),
        'bottom_price'=>array('required'=>'no', 'blank'=>'yes', 'default'=>'0', 'name'=>'Bottom Price'),
        'cost_per_unit'=>array('required'=>'no', 'blank'=>'yes', 'name'=>'Cost per Unit'),
