...
function ciniki_herbalist_productVersionHistory($ciniki) {
    ...
    $rc = ciniki_herbalist_checkAccess($ciniki, $args['tnid'], 'ciniki.herbalist.productVersionHistory');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }

    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'dbGetModuleHistory');
    return ciniki_core_dbGetModuleHistory($ciniki, 'ciniki.herbalist', 'ciniki_herbalist_history', $args['tnid'], 'ciniki_herbalist_product_versions', $args['productversion_id'], $args['field']);
}
?>
