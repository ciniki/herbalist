...
// <rsp stat='ok' />
//
function ciniki_herbalist_ailmentUpdate(&$ciniki) {
    //
    ...
    $rc = ciniki_herbalist_checkAccess($ciniki, $args['business_id'], 'ciniki.herbalist.ailmentUpdate');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    //
    // Update the Ailment in the database
    //
    ciniki_core_loadMethod($ciniki, 'ciniki', 'core', 'private', 'objectUpdate');
    $rc = ciniki_core_objectUpdate($ciniki, $args['business_id'], 'ciniki.herbalist.ailment', $args['ailment_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
    ...
    ciniki_core_hookExec($ciniki, $args['business_id'], 'ciniki', 'web', 'indexObject', array('object'=>'ciniki.herbalist.ailment', 'object_id'=>$args['ailment_id']));
