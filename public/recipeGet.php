...
function ciniki_herbalist_recipeGet($ciniki) {
    ...
    $rc = ciniki_herbalist_checkAccess($ciniki, $args['tnid'], 'ciniki.herbalist.recipeGet');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    //
        ...
        $strsql = "SELECT ciniki_herbalist_recipes.id, "
            ...
            . "ciniki_herbalist_recipes.recipe_type, "
        ...
        $rc = ciniki_core_dbHashQueryArrayTree($ciniki, $strsql, 'ciniki.herbalist', array(
            array('container'=>'batches', 'fname'=>'id', 
                'fields'=>array('id', 'production_date', 'size', 'yield', 'production_time', 'materials_cost_per_unit', 'time_cost_per_unit', 'total_cost_per_unit', 'total_time_per_unit'),
        ...
        $rc = ciniki_herbalist_objectNotes($ciniki, $args['tnid'], 'ciniki.herbalist.recipe', $args['recipe_id']);
        if( $rc['stat'] != 'ok' ) {
            return $rc;
        }
        if( isset($rc['notes']) ) {
