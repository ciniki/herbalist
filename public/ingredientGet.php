...
function ciniki_herbalist_ingredientGet($ciniki) {
    ...
    $rc = ciniki_herbalist_checkAccess($ciniki, $args['tnid'], 'ciniki.herbalist.ingredientGet');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    //
        ...
        $rc = ciniki_herbalist_objectNotes($ciniki, $args['tnid'], 'ciniki.herbalist.ingredient', $args['ingredient_id']);
        if( $rc['stat'] != 'ok' ) {
            return $rc;
        }
        if( isset($rc['notes']) ) {
