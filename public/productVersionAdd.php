...
function ciniki_herbalist_productVersionAdd(&$ciniki) {
    ...
    if( $rc['num_rows'] > 0 ) {
        return array('stat'=>'fail', 'err'=>array('pkg'=>'ciniki', 'code'=>'3455', 'msg'=>'You already have a product version with that name, please choose another.'));
    }
    ...
    ciniki_core_hookExec($ciniki, $args['business_id'], 'ciniki', 'web', 'indexObject', array('object'=>'ciniki.herbalist.productVersion', 'object_id'=>$version_id));

    return array('stat'=>'ok', 'id'=>$version_id);
}
?>
