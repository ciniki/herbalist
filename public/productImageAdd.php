...
function ciniki_herbalist_productImageAdd(&$ciniki) {
    ...
    $rc = ciniki_herbalist_checkAccess($ciniki, $args['tnid'], 'ciniki.herbalist.productImageAdd');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    ciniki_core_hookExec($ciniki, $args['tnid'], 'ciniki', 'web', 'indexObject', array('object'=>'ciniki.herbalist.productImage', 'object_id'=>$productimage_id));
