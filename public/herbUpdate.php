...
function ciniki_herbalist_herbUpdate(&$ciniki) {
    ...
    $rc = ciniki_core_objectUpdate($ciniki, $args['business_id'], 'ciniki.herbalist.herb', $args['herb_id'], $args, 0x04);
    if( $rc['stat'] != 'ok' ) {
    ...
    ciniki_core_hookExec($ciniki, $args['business_id'], 'ciniki', 'web', 'indexObject', array('object'=>'ciniki.herbalist.herb', 'object_id'=>$args['herb_id']));
