...
function ciniki_herbalist_settingsUpdate(&$ciniki) {
    ...
    $rc = ciniki_herbalist_checkAccess($ciniki, $args['tnid'], 'ciniki.herbalist.settingsUpdate'); 
    if( $rc['stat'] != 'ok' ) { 
        return $rc;
    }   
    ...
    foreach($changelog_fields as $field) {
        if( isset($ciniki['request']['args'][$field]) ) {
            $strsql = "INSERT INTO ciniki_herbalist_settings (tnid, detail_key, detail_value, date_added, last_updated) "
            ...
            ciniki_core_dbAddModuleHistory($ciniki, 'ciniki.herbalist', 'ciniki_herbalist_history', $args['tnid'], 
